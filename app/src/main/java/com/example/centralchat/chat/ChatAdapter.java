...
public class ChatAdapter extends RecyclerView.Adapter<ChatAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        if (list2.getIndexNum().equals(userIndexNum)) {
            ...
            holder.myTime.setText(context.getString(R.string.timeStamp, list2.getDate(), list2.getTime()));
        }else {
            holder.myLayout.setVisibility(View.GONE);
            holder.oppoLayout.setVisibility(View.VISIBLE);

            holder.oppoMessage.setText(list2.getMessage());
            holder.oppoTime.setText(context.getString(R.string.timeStamp, list2.getDate(), list2.getTime()));
        }
    }
